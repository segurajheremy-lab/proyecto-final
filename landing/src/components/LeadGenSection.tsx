      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="bg-white border border-slate-100 shadow-xl rounded-2xl p-8">
          ...
          <div className="space-y-4">
            ...
            <button className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 text-white font-semibold py-3 rounded-lg transition-colors shadow-md shadow-blue-600/20">
              Comenzar gratis
              <ArrowRight size={18} />
            </button>
          </div>
